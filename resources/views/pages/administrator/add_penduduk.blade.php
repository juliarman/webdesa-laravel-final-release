            ...
            <form action="/input-penduduk" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" name="nik" id="nik" placeholder="" value="" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control" name="nkk" id="nkk" placeholder="" value="" required>
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="alamat" id="alamat" placeholder="" value="" required>
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="nohp" id="nohp" placeholder="" value="" required>
                        <div class="invalid-feedback">
                            Valid last name is required.
                        </div>
                    </div>
