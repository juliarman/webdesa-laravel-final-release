                    ...
                    <div class="col-lg-12">
                        <form method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$dataBumdes->judul}}" class="form-control"
                                    placeholder="Masukkan judul berita" name="judul">
                            </div>

                            <div class="form-group">
                                <label for="subJudulBerita">Sub Judul Berita</label>
                                <input type="text" value="{{$dataBumdes->sub_judul}}" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" value="Terbit"
                                        {{ $dataBumdes->status == 'Terbit' ? 'checked' : '' }} type="radio" name="status"
                                        id="statusBerita">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" value="Draft"
                                        {{ $dataBumdes->status == 'Draft' ? 'checked' : '' }} type="radio" name="status"
                                        id="statusBerita">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="thumbnail" value="{{ $dataBumdes->gambar }}" class="form-control"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea id="my-editor" name="content"
                                            class="form-control">{!! $dataBumdes->isi_konten !!}</textarea>
