        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form method="POST" action="/tulis-berita">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Sub judul berita" name="subjudul">
                            </div>

                            <div class="form-group">

                                <label for="country">kategori Berita</label>
                                <select class="custom-select d-block w-100" id="country" name="categories_id" required>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-success">SUBMIT BERITA</button>
